...
<body>
    <header class="container text-center">
        ...
        <p>Somos Engenheiros de Computação . Ensinamos pensamento computacional para estudantes do Ensino
    ...
    <footer class="container py-5">
        ...
        <p class="my-5 text-center">© Copyright 2024. Produzido por Alunos do Conti </p>
    </footer>
